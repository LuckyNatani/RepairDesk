            ...
            <main className="max-w-[1400px] mx-auto p-6 md:p-8">
                {!stats ? (
                    <div className="flex flex-col items-center justify-center p-12 bg-white rounded-xl border border-slate-200 shadow-sm text-center">
                        ...
                        <h2 className="text-lg font-semibold text-slate-900 mb-2">Not Enough Data</h2>
                        <p className="text-slate-500 max-w-sm">Create tasks and add staff members to start seeing operational insights and performance metrics here.</p>
                    </div>
                ) : (
                    <>
                        {/* Primary Stats */}
