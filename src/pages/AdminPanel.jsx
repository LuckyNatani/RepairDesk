                            ...
                            <li key={member.id} className="p-4 md:p-6 hover:bg-slate-50/80 transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-4 group">
                                ...
                                <div className="flex items-center gap-2 mt-3 sm:mt-0 w-full sm:w-auto">
                                    <button
                                        ...
                                        className="flex-1 sm:flex-none px-3 py-1.5 text-xs font-medium text-slate-600 bg-slate-50 hover:bg-slate-100 hover:text-indigo-700 rounded-md transition-colors border border-slate-200 sm:border-transparent sm:bg-transparent sm:hover:bg-indigo-50 sm:hover:border-indigo-100 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 flex items-center justify-center gap-1.5"
                                        title="Edit Staff"
                                    >
                                        <Edit2 size={14} />
                                    ...
                                    <button
                                        ...
                                        className="flex-1 sm:flex-none px-3 py-1.5 text-xs font-medium text-red-600 bg-red-50 hover:bg-red-100 hover:text-red-700 rounded-md transition-colors border border-red-100 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 flex items-center justify-center gap-1.5"
                                        title="Remove Staff"
                                    >
                                        <Trash2 size={14} />
